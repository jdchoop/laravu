              ...
              <div class="card card-info">
                ...
                <div class="card-footer">
                  <div class="row">
                    ...
                    <button class="btn btn-flat btn-info btnWidth" @click.prevent="getListarPermisos"
                    ...
                    <tbody>
                      <tr v-for="(item, index) in listarPermisosPaginated " :key="index">
                        ...
                        <td>
                          ...
                          <router-link class="btn btn-info btn-sm" :to="{name:'permiso.editar', params:{id: item.id}}">
