              ...
              <div class="card card-info">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            ...
                            v-model="fillBsqProducto.cNombre" @keyup.enter="getListarProductos" >
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control" 
                            v-model="fillBsqProducto.cDescripcion" @keyup.enter="getListarProductos">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <el-select v-model="fillBsqProducto.nIdCategoria" placeholder="Seleccione una CATEGORIA" clearable>
                            <el-option
                ...
                <div class="card-footer">
                  <div class="row">
                    ...
                    <button class="btn btn-flat btn-info btnWidth" @click.prevent="getListarProductos"
                      ...
                      <tr v-for="(item, index) in listarProductosPaginated " :key="index">
                        ...
                        <td>
                            ...
                            <template v-if="listRolPermisosByUsuario.includes('producto.editar')">
                              <router-link class="btn btn-info btn-sm" :to="{name:'producto.editar', params:{id: item.id}}">
