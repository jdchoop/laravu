              ...
              <div class="card-body box-profile">
                <div class="text-center">
                    <template v-if="!fillVerUsuario.cRutaArchivo">
                              <img class="profile-user-img img-fluid img-circle img-max-height" 
                              src="/img/avatar.png" alt="foto">
                          </template>
                          <template v-else>
                              <img :src="fillVerUsuario.cRutaArchivo" :alt="cNombreCompleto" 
                              class="profile-avatar-img img-fluid img-circle img-max-height"> 
                          </template>
                   </div>
                ...
                <ul class="nav nav-pills position-reverse">
                  <li class="nav-item">
                    <router-link class="nav-link active" :to="'/usuario'">
                      <i class="fasfa-arrow-left"></i>Regresar
                    </router-link>
                  </li>
                </ul>
              </div><!-- /.card-header -->
                  ...
                  <div class="tab-pane active" id="settings">
                    <form class="form-horizontal">
                      <div class="form-group row">
                        <label for="inputName" class="col-md-3 col-form-label">Primer Nombre</label>
                        <div class="col-md-9">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <el-input placeholder="Ingrese Contraseña" v-model="fillEditarUsuario.cContraseña" 
                            @keyup.enter="setEditarUsuario" show-password></el-input></div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        <div class="col-sm-12">
                          <button class="btn btn-flat btn-info btnFull" @click.prevent="setEditarUsuario" 
