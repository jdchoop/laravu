          ...
          <div class="card-body">
            ...
            <div class="card card-info">
                      ...
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            ...
                            v-model="fillEditarRol.cNombre" @keyup.enter="setEditarRolPermisos" >
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control" 
                            v-model="fillEditarRol.cSlug" @keyup.enter="setEditarRolPermisos" >
                          </div>
                        </div>
                      </div>
                ...
                <div class="card-footer">
                  <div class="row">
                    <button class="btn btn-flat btn-info btnWidth" @click.prevent="setEditarRolPermisos"
      ...
      filterListarRolPermisosByUsuario(){
         ...
         this.fullscreenLoading= false;
          Swal.fire({
                  ...
                  icon: 'success',
                  title: 'SE ACTUALIZO ROL CORRECTO',
