          ...
          <div class="card-header">
            <div class="card-tools">
              <template v-if="listRolPermisosByUsuario.includes('categoria.crear')">
                ...
                <i class="fas fa-plus-square"></i>Nuevo Categoria
                </router-link> 
              </template>
              ...
              <div class="card card-info">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            ...
                            v-model="fillBsqCategoria.cNombre" @keyup.enter="getListarCategorias" >
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control" 
                            v-model="fillBsqCategoria.cDescripcion" @keyup.enter="getListarCategorias">
                          </div>
                        </div>
                      </div>
                ...
                <div class="card-footer">
                  <div class="row">
                    ...
                    <button class="btn btn-flat btn-info btnWidth" @click.prevent="getListarCategorias"
                      ...
                      <tr v-for="(item, index) in listarCategoriasPaginated " :key="index">
                        ...
                        <td>
                            ...
                            <template v-if="listRolPermisosByUsuario.includes('categoria.editar')">
                              <router-link class="btn btn-info btn-sm" :to="{name:'categoria.editar', params:{id: item.id}}">
