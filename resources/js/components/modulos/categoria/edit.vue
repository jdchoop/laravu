          ...
          <div class="card-body">
            <div class="container-fluid">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                        <h3 class="card-title">Formulario Editar Categorias</h3>
                        </div>
                        <div class="card-body">
                        <form action="" role="form">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-9">
                                    ...
                                    v-model="fillEditarCategoria.cNombre" @keyup.enter="setEditarCategoria" >
                                </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" 
                                    v-model="fillEditarCategoria.cDescripcion" @keyup.enter="setEditarCategoria" >
                                </div>
                                </div>
                            </div>
                        ...
                        <div class="card-footer">
                            ...
                            <div class="col-md-4 offset-4">
                                <button class="btn btn-flat btn-info btnWidth" @click.prevent="setEditarCategoria"
  ...
  methods: {
      ...
      setEditarCategoria(){
          ...
          axios.post(url, {
              ...
              Swal.fire({
                  icon: 'success',
                  title: 'SE ACTUALIZO CATEGORIA CORRECTO',
