...
export const rutas =[
  ...
  { path: '/pedido/crear', name:'pedido.crear', 
    ...
    { path: '/cliente', name:'cliente.index', 
    ...
    { path: '/categoria', name:'categoria.index', 
  ...
  { path: '/categoria/crear', name:'categoria.crear', 
  ...
  { path: '/categoria/editar/:id', name:'categoria.editar', 
    ...
    { path: '/producto', name:'producto.index', 
  ...
  { path: '/producto/crear', name:'producto.crear', 
...
{ path: '/producto/editar/:id', name:'producto.editar', 
    ...
    { path: '/usuario', name:'usuario.index', 
    ...
    { path: '/usuario/crear', name:'usuario.crear', 
    ...
    { path: '/permiso', name: 'permiso.index', 
    ...
    { path: '/permiso/crear', name: 'permiso.crear', 
    ...
    { path: '/reporte', name: 'reporte.pedido.index', 
